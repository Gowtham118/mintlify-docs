...
interface AuthConfig {
    ...
    aarcApiKey: string; // get the aarcApiKey from dashboard
}
...
> **Note:** Make sure you import the style.css for the widget UI to render properly.

> **Note:** For NextJS: Since the Aarc auth widget is meant to be used on the client side please make sure the code is running on the client side, by specifying 'use client' at the top of the file.
