...
description: This guide demonstrates how to implement cross-chain deposits using Aarc's FundKit SDK. The example shows how to create a dApp that allows users to deposit funds from any supported chain to a destination contract on any chain. 
---
...
```bash
npm create vite@latest my-cross-chain-deposit -- --template react-ts
cd my-cross-chain-deposit
```
...
![Minting in Progress](/images/deposit-progress.png)
*User selecting payment method in Aarc modal*

![Minting Complete](/images/deposit-complete.png)
