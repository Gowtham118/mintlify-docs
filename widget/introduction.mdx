...
Aarc SDK provides a very simple yet efficient way to solve this issue, the Aarc Execution Cloud Widget.

The Aarc Execution Cloud Widget has all the necessary options an application needs to onboard new users, like:
